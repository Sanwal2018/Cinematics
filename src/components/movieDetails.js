    ...
    this.setState({
      shareOptions: {
        ...
        url:
          ...
          this.props.movie.id +
          "-" +
          this.props.movie.title.replace(/ /g, "-"), //https://www.themoviedb.org/movie/284054-black-panther
        subject: "Cinematics-The Movie APP Movie :" + this.props.movie.title //  for email
      }
    });
  }
