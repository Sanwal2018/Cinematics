    ...
    this.setState({
      shareOptions: {
        ...
        url:
          ...
          this.props.tv.id +
          "-" +
          this.props.tv.name.replace(/ /g, "-"), //https://www.themoviedb.org/tv/284054-black-panther
        subject: "Cinematics-The Movie APP TV Show:" + this.props.tv.name //  for email
      }
    });
  }
        ...
        <View style={styles.container}>
              ...
              >
                <TouchableOpacity style={styles.modalData}>
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({ isModalVisible: false });
                      Linking.openURL("https://www.themoviedb.org/talk");
                    }}
                    style={styles.modalItem}
                  >
          ...
          <View style={styles.caraosulContainer}>
            ...
            <Image
              ...
              source={{ uri: imgPath + this.props.tv.poster_path }}
              style={{
                width: width * 0.2,
                height: height * 0.18,
                position: "absolute",
